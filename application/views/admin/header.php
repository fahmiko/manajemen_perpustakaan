...
<div id="wrapper" class="active">
  <div id="sidebar-wrapper">
    <ul id="sidebar_menu" class="sidebar-nav">
        <li class="sidebar-brand"><a id="menu-toggle" href="#"><?php echo $session['username'] ?><span id="main_icon" class="glyphicon glyphicon-align-justify"></span></a></li>
    </ul>
    <ul class="sidebar-nav" id="sidebar">     
      <li><a href="#">Home<span class="sub_icon glyphicon glyphicon-home"></span></a></li>
      <li><a href="#">Kategori<span class="sub_icon glyphicon glyphicon-tag"></span></a></li>
      <li><a href="#">Buku<span class="sub_icon glyphicon glyphicon-book"></span></a></li>
